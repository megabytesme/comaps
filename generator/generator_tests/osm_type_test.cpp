...
UNIT_CLASS_TEST(TestWithClassificator, OsmType_RailwayRail)
{
  ...
  std::vector<std::pair<Type, Tags>> const railTypes = {
      ...
      {{"railway", "rail", "branch", "bridge"},
       {{"railway", "rail"}, {"usage", "branch"}, {"bridge", "positive_value"}}},
      ...
      {{"railway", "rail", "branch", "tunnel"},
       {{"railway", "rail"}, {"usage", "branch"}, {"tunnel", "positive_value"}}},
...
UNIT_CLASS_TEST(TestWithClassificator, OsmType_ComplexTypesSmoke)
{
  ...
  std::vector<std::pair<Type, Tags>> const complexTypes = {
      ...
      //
      // two types (+hwtag yesbicycle) {{"highway", "path", "bicycle"}, {{"highway", "path"}, {"bicycle",
      // "any_value"}}},
      ...
      {{"natural", "wetland", "marsh"}, {{"natural", "wetland"}, {"wetland", "wet_meadow"}}},
      {{"natural", "wetland", "saltmarsh"}, {{"natural", "wetland"}, {"wetland", "saltmarsh"}}},
      {{"natural", "wetland", "saltmarsh", "tidal"},
       {{"natural", "wetland"}, {"wetland", "saltmarsh"}, {"tidal", "yes"}}},
      {{"natural", "wetland", "fen"}, {{"natural", "wetland"}, {"wetland", "fen"}}},
      {{"natural", "wetland", "reedbed"}, {{"natural", "wetland"}, {"wetland", "reedbed"}}},
      {{"natural", "wetland", "swamp"}, {{"natural", "wetland"}, {"wetland", "swamp"}}},
      {{"natural", "wetland", "mangrove"}, {{"natural", "wetland"}, {"wetland", "mangrove"}}},
      {{"natural", "wetland", "tidalflat"}, {{"natural", "wetland"}, {"wetland", "tidalflat"}}},
      ...
      {{"railway", "station", "subway", "berlin"},
       {{"railway", "station"}, {"transport", "subway"}, {"city", "berlin"}}},
      ...
      {{"railway", "station", "subway", "moscow"},
       {{"railway", "station"}, {"transport", "subway"}, {"city", "moscow"}}},
      {{"railway", "station", "subway", "newyork"},
       {{"railway", "station"}, {"station", "subway"}, {"city", "newyork"}}},
      {{"railway", "station", "subway", "newyork"},
